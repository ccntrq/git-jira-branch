...
const configErrorToAppConfigError = (configError: ConfigError.ConfigError) =>
  pipe(
    configError,
    ConfigError.reduceWithContext(void 0, collectConfigErrorMessagesReducer),
...
export class AppConfigService extends Context.Tag('AppConfigService')<
  AppConfigService,
  {
    ...
    readonly defaultJiraKeyPrefix: Effect.Effect<
      Option.Option<JiraKeyPrefix>,
      AppConfigError,
      never
    >;
  }
